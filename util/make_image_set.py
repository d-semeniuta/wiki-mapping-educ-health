...
os.system('gdal_translate -r lanczos -tr 0.1 0.1  -co COMPRESS=LZW ../data/raw/nightlights/GUF_Continent_Africa.tif '
          '../data/raw/nightlights/GUF_Continent_Africa_tenth.tif')
